...
1. Moving over to socket architecture vs file reads
2. `--retrieve` option for scratchpad deletion
...
3. `niri-scratchpad spawn <scratchpad_number> <cmd_str>` action
